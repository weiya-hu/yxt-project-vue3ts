<template>
  <div class="msgdata_page_c">
    ...
    <PeopleTable :data="tableData" details="/findC/msgDataDetails" @select="selectTable" @del="sureDel"/>
...
import { addMsg_api ,getMsgList_api,delMsg_api} from '@/api/findC'
