<template>
  <div class="biddingdata_page_c">
    ...
    <PeopleTable :data="tableData" details="/findC/biddingDataDetails" @select="selectTable" @del="sureDel"/>
...
import { addBidding_api ,getBiddingList_api,delBidding_api} from '@/api/findC'
...
const sureDel = (id:string)=>{
  delBidding_api({id}).then((res:res)=>{
