<template>
  <div class="bigdata_page_c">
    ...
    <PeopleTable :data="tableData" details="/findC/bigDataDetails" @select="selectTable" @del="sureDel"/>
...
import { addBig_api ,getBigList_api,delBig_api} from '@/api/findC'
