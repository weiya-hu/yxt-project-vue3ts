  ...
  <div class="article_details">
    ...
    <div class="content">
      ...
      <div class="nav-tips">
          ...
          <div class="btns">
            <el-button color="#2D68EB" class="bdc_btn" plain v-if="body.status == 1" @click="getUp">上线</el-button>
            <el-button color="#2D68EB" class="bdc_btn" plain v-if="body.status == 2" @click="getDown">下线</el-button>
            <el-button color="#2D68EB" class="bdc_btn" plain v-if="body.status == 1 || body.status == 0" @click="">编辑</el-button>
            <el-button color="#2D68EB" class="bdc_btn" plain v-if="body.status == 1 || body.status == 0" @click="getDel(id)">删除</el-button>
          </div>
      </div>
      <el-card>
