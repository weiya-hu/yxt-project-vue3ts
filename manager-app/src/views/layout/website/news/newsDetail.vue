    ...
    <div class="content">
      ...
      <div class="nav-tips">
        ...
        <div class="ss">
          <div
            class="point"
            :style="body.state == 4 ? 'background: #24BD13;' : 'background:#E40000;'"
          ></div>
          ...
          <div
            ...
            :style="
              body.state == 1
                ...
                : body.state == 2
                ? 'background: rgba(228, 0, 0, 0.1);color: #E40000 ;'
                : body.state == 0
                ? 'background:  rgba(81, 161, 252, 0.1);color: #51A1FC ;'
                ...
                <el-card class="mycard">
                  <div class="comment-card">
                    ...
                    <div class="userInfo">
                      ...
                      <span class="utime">{{
                        formatDate(new Date(v.update_time), 'yyyy-MM-dd hh:mm:ss')
                      }}</span>
