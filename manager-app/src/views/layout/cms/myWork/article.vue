      ...
      <div class="mytable">
        ...
        >
          ...
          <el-table-column label="标题" :show-overflow-tooltip="true" width="350" align="center">
            <template #default="{ row }">
              <el-link type="primary" @click="$router.push('/cms/myworkdet?id=' + row.id)">{{
                row.title
              }}</el-link>
            </template>
          </el-table-column>
...
function anync(id: any, string: any) { throw new Error('Function not implemented.') } function
id(id: any, string: any) { throw new Error('Function not implemented.') }
