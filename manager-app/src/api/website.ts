...
// 获取通知分类
export const dynamicTypeList_api = (): Promise<res> => {
  return get(1, '/official/dynamic/type.list')
}
// 获取通知分类
export const noticeTypeList_api = (): Promise<res> => {
  return get(1, '/official/notice/type.list')
}
//添加新闻分类
